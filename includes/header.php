...
<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top shadow-sm py-3">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="/apex/pages/rr-home-project.php">
            <img src="/apex/assets/images/rr-home-logo.png" alt="RR Home" style="max-height: 70px; width: auto; object-fit: contain;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-2">
                <li class="nav-item">
                    <a class="nav-link fw-semibold <?php echo $current_page == 'home.php' ? 'active text-warning' : ''; ?>" href="/apex/pages/home.php">HOME</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-semibold <?php echo $current_page == 'about.php' ? 'active text-warning' : ''; ?>" href="/apex/pages/about.php">ABOUT US</a>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark shadow border-0 mt-2" aria-labelledby="rrHomeDropdown" style="background-color: #343a40;">
                        <?php if (count($rr_projects) > 0): ?>
                            <?php foreach ($rr_projects as $proj): ?>
                                <li><a class="dropdown-item py-2" href="/apex/pages/project-details.php?id=<?= $proj['id'] ?>"><?= htmlspecialchars($proj['title']) ?></a></li>
                            <?php endforeach; ?>
                        <?php else: ?>
                ...
                <li class="nav-item">
                    <a class="nav-link fw-semibold <?php echo $current_page == 'contact.php' ? 'active text-warning' : ''; ?>" href="/apex/pages/contact.php">CONTACT US</a>
                </li>
            </ul>
            <div class="d-flex align-items-center gap-4">
                <a href="/apex/pages/apex-project.php" class="d-none d-lg-block">
                    <img src="/apex/assets/images/apex_logo.png" alt="Apex" style="max-height: 95px; width: auto; object-fit: contain;">
                </a>
