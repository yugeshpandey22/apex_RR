...
<div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
  ...
  <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?= BASE_URL ?>assets/images/hero-1.webp" class="d-block w-100 img-fluid" alt="Premium Amenities">
        ...
        <div class="carousel-item">
          <img src="<?= BASE_URL ?>assets/images/rr%20home%20banner.webp" class="d-block w-100 img-fluid" alt="The Royal">
          <div class="carousel-caption d-flex flex-column align-items-center justify-content-center" style="top: 0; bottom: 0; left: 0; right: 0; background: rgba(0,0,0,0.5);">
            <div class="text-center text-white px-3 animate-fade-up">
        ...
        <div class="carousel-item">
          <img src="<?= BASE_URL ?>assets/images/apex%20banner.webp" class="d-block w-100 img-fluid" alt="The Price Simple Project">
          <div class="carousel-caption d-flex flex-column align-items-center justify-content-center" style="top: 0; bottom: 0; left: 0; right: 0; background: rgba(0,0,0,0.5);">
            <div class="text-center text-white px-3 animate-fade-up">
