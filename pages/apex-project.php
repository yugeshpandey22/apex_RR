...
<section class="position-relative bg-dark w-100 overflow-hidden">
    <img src="<?= BASE_URL ?>assets/images/apex%20banner.webp" class="w-100 project-page-banner" alt="Apex Projects Banner" style="height: 400px; object-fit: fill; display: block;">
