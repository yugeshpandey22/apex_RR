...
<section class="project-hero w-100" style="background-color: #f8f9fa;">
    <picture>
        ...
        <img src="<?= htmlspecialchars($desktop_bg) ?>" class="d-block project-banner-img shadow-sm" alt="Project Banner">
    </picture>
</section>
            ...
            <div class="col-lg-4">
                <div class="sidebar-contact p-4 p-xl-5 rounded-4 shadow-lg sticky-top tp-sidebar-contact" style="top: 100px; background: linear-gradient(145deg, #ffffff, #f0f0f0); border: 1px solid #e0e0e0;">
                    ...
                    <form action="send-enquiry" method="POST">
                        ...
                        <div class="mb-4">
                            <input type="tel" class="form-control py-3 pe-3 rounded-3 bg-white border" name="phone" placeholder="Enter your phone number" pattern="[0-9]{10}" maxlength="10" minlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')" title="Please enter exactly 10 digits" required>
                        </div>
